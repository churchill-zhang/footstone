// Copyright 2013 The Tencent Authors. All rights reserved.
...
class ScopedCleanupClosure {
 public:
  ...
  ScopedCleanupClosure(const closure& closure) : closure_(closure) {}
  ...
  closure SetClosure(const closure& closure) {
 ...
 private:
  ...
  TDF_BASE_DISALLOW_COPY_AND_ASSIGN(ScopedCleanupClosure);
};
